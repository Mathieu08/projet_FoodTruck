...
L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/streets-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZ29yZWFmcm9tYW4iLCJhIjoiY2lxY2t0dzViMDJhamZ5bnBndDhyNm9xMyJ9.d5YvbUN58tpwR09z5Iet8g', {
    ...
    accessToken: 'your.mapbox.public.access.token'
            ...
            for (var i = json.length - 1; i >= 0; i--) {
              ...
              marker.bindPopup("<b>Nom: </b>" + json[i].nom + "<br><b>Lieu: </b>" + json[i].lieu + "<br><b>Jour: </b>" + json[i].dateTruck + "<br><b>Heure d'arrivé: </b>" + json[i].heureDebut + "<br><b>Heure de départ: </b>" + json[i].heureFin);              
    ...
    xmlHttp.onreadystatechange = function() {
      if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
        ...
        for (var i=0; i < station.length; i++) {
          ...
          stationMarker.bindPopup("<b>Nom: </b>" + station[i].nom + "<br><b>Nombre de velos: </b>" + station[i].nbVelos + "<br><b>Nombre de place disponible: </b>" + station[i].disponibilite);
